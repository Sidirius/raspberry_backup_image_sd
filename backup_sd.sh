...
SUBDIR=Backup.Image.RaspberryPi
DIR=smb://pi:raspberry@1.1.1.21/usbhdd1/$SUBDIR
...
echo "Backing up SD card to PATH."
...
if [ $RESULT = 0 ];
   then
      echo "Successful backup, previous backup files, older than 5 days, will be deleted."
